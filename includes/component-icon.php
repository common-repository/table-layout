...
class MMTL_Component_Icon
{
	...
	public function register_component_settings()
	{
		...
		MMTL_API::add_settings_section( 'attributes', __( 'Attributes', 'table-layout' ), '', 'mmtl-icon' );

		MMTL_API::register_setting( 'mmtl-icon', 'id', 'trim|sanitize_title' );
		MMTL_API::add_settings_field( 'id', __( 'ID' ), array( 'MMTL_Form', 'textfield' ), 'mmtl-icon', 'attributes', array
		(
			'id'        => 'mmtl-id',
			'label_for' => 'mmtl-id',
			'class'     => '',
		...
		MMTL_API::register_setting( 'mmtl-icon', 'class' );
		MMTL_API::add_settings_field( 'class', __( 'Class', 'table-layout' ), array( 'MMTL_Form', 'textfield' ), 'mmtl-icon', 'attributes', array
		(
			'id'        => 'mmtl-class',
	...
	{
		if ( ! is_admin() && ! MMTL_Common::is_shortcode_used( 'mmtl-icon' ) )
		{
			return;
		}
	...
	{
		if ( ! MMTL_Common::is_shortcode_used( 'mmtl-icon' ) )
		{
			return;
		}
...
MMTL_Component_Icon::get_instance()->init();
