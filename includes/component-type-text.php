...
class MMTL_Component_Type_Text
{
	...
	public function add_meta_boxes()
	{
		...
		if ( ! $component_id || $component_id != 'mmtl-text' )
		{
			return;
		}

		add_meta_box( 'mmtl-component-type-text', __( 'Settings', 'table-layout' ), array( $this, 'print_meta_box_inner' ), 'mmtl_component_type' );
	}
...
MMTL_Component_Type_Text::get_instance()->init();
