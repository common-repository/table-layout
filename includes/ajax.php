...
class MMTL_Ajax
{
	...
	public function init()
	{
		...
		add_action( 'wp_ajax_mmtl_update_stylesheet', array( $this, 'update_stylesheet' ) );
	}
	...
	public function update_stylesheet()
	{
		...
		check_admin_referer( 'update_stylesheet', MMTL_NONCE_NAME );

		$result = MMTL_Component_Types::get_instance()->update_stylesheet();
	...
	public function get_settings_page()
	{
		...
		$html = MMTL_Component_Settings::get_instance()->get_settings_page( $page );
	...
	public function sanitize_options()
	{
		...
		$options = MMTL_Component_Settings::get_instance()->sanitize_options();
