...
class MMTL_Editor
{
	...
	{
		// makes sure auto paragraphs are enabled
	...
	public function enqueue_scripts()
	{
		...
		$types = get_posts( 'post_type=mmtl_component_type&numberposts=999' );

		foreach ( $types as $type )
		{
			$type_options[ $type->post_name ] = $type->post_title;
		}
		...
		(
			...
			'meta_title_type'          => __( 'Type', 'table-layout' ),
			'components'               => $this->get_components(),
