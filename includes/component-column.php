...
class MMTL_Component_Column
{
	...
	public function register_component_settings()
	{
		...
		MMTL_API::add_settings_section( 'background', __( 'Background', 'table-layout' ), '', 'mmtl-col' );

		MMTL_API::register_setting( 'mmtl-col', 'bg_image' );
		MMTL_API::add_settings_field( 'bg_image', __( 'Image', 'table-layout' ), array( 'MMTL_Form', 'image_picker' ), 'mmtl-col', 'background', array
		(
			'id'        => 'mmtl-bg_image',
		...
		MMTL_API::register_setting( 'mmtl-col', 'bg_repeat' );
		MMTL_API::add_settings_field( 'bg_repeat', __( 'Repeat', 'table-layout' ), array( 'MMTL_Form', 'dropdown' ), 'mmtl-col', 'background', array
		(
			'id'        => 'mmtl-bg_repeat',
		...
		MMTL_API::register_setting( 'mmtl-col', 'bg_position' );
		MMTL_API::add_settings_field( 'bg_position', __( 'Position', 'table-layout' ), array( 'MMTL_Form', 'dropdown' ), 'mmtl-col', 'background', array
		(
			'id'        => 'mmtl-bg_position',
		...
		MMTL_API::register_setting( 'mmtl-col', 'bg_size' );
		MMTL_API::add_settings_field( 'bg_size', __( 'Size', 'table-layout' ), array( 'MMTL_Form', 'dropdown' ), 'mmtl-col', 'background', array
		(
			'id'        => 'mmtl-bg_size',
		...
		MMTL_API::add_settings_section( 'attributes', __( 'Attributes', 'table-layout' ), '', 'mmtl-col' );

		MMTL_API::register_setting( 'mmtl-col', 'id', 'trim|sanitize_title' );
		MMTL_API::add_settings_field( 'id', __( 'ID' ), array( 'MMTL_Form', 'textfield' ), 'mmtl-col', 'attributes', array
		(
			'id'        => 'mmtl-id',
			'label_for' => 'mmtl-id',
			'class'     => '',
		...
		MMTL_API::register_setting( 'mmtl-col', 'class' );
		MMTL_API::add_settings_field( 'class', __( 'Class', 'table-layout' ), array( 'MMTL_Form', 'textfield' ), 'mmtl-col', 'attributes', array
		(
			'id'        => 'mmtl-class',
	...
	public function parse( $atts, $content = '' )
	{
		...
		if ( $type )
		{
			$my_classes[] = MMTL_API::get_component_type_class( $type );
		}
...
MMTL_Component_Column::get_instance()->init();
