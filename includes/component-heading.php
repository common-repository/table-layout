...
class MMTL_Component_Heading
{
	...
	public function register_component_settings()
	{
		...
		MMTL_API::add_settings_section( 'attributes', __( 'Attributes', 'table-layout' ), '', 'mmtl-heading' );

		MMTL_API::register_setting( 'mmtl-heading', 'id', 'trim|sanitize_title' );
		MMTL_API::add_settings_field( 'id', __( 'ID' ), array( 'MMTL_Form', 'textfield' ), 'mmtl-heading', 'attributes', array
		(
			'id'        => 'mmtl-id',
			'label_for' => 'mmtl-id',
			'class'     => '',
		...
		MMTL_API::register_setting( 'mmtl-heading', 'class' );
		MMTL_API::add_settings_field( 'class', __( 'Class', 'table-layout' ), array( 'MMTL_Form', 'textfield' ), 'mmtl-heading', 'attributes', array
		(
			'id'        => 'mmtl-class',
...
MMTL_Component_Heading::get_instance()->init();
