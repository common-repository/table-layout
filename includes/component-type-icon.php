...
class MMTL_Component_Type_Icon
{
	...
	public function add_meta_boxes()
	{
		...
		if ( ! $component_id || $component_id != 'mmtl-icon' )
		{
			return;
		}

		add_meta_box( 'mmtl-component-type-icon', __( 'Settings', 'table-layout' ), array( $this, 'print_meta_box_inner' ), 'mmtl_component_type' );
	}
	...
	public function print_meta_box_inner( $post )
	{
		...
		<div class="mmtl-form-group">
			<label for="mmtl-size"><?php _e( 'Size', 'table-layout' ); ?></label>
			<div class="mmtl-input-group">
				<input type="number" id="mmtl-size" class="mmtl-form-control" name="mmtl_size" value="<?php echo esc_attr( $size ); ?>">
	...
	public function save_post( $post_id )
	{
		...
		if ( isset( $_POST['mmtl_size'] ) )
		{
			update_post_meta( $post_id, 'size', sanitize_text_field( $_POST['mmtl_size'] ) );
		}
	...
	{
		if ( $component_id == 'mmtl-icon' )
		{
			MMTL_API::log( sprintf( '%s (#%s) css', get_the_title( $post_id ), $post_id ) );
			...
			MMTL_CSS::add_declaration( 'font-size', $size . 'px', $declarations );
			MMTL_CSS::add_declaration( 'line-height', $size . 'px', $declarations );
			MMTL_CSS::add_declaration( 'width', $size . 'px', $declarations );
			MMTL_CSS::add_declaration( 'height', $size . 'px', $declarations );
...
MMTL_Component_Type_Icon::get_instance()->init();
